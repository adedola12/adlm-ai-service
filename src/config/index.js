...
export const config = {
  ...
  // Bumped for the rate build-up pro-rating rules (gang day-rates must be
  // divided by an output rate). Also busts cached build-ups produced before
  // the rule, which is intended — some of them charged a full gang-day
  // against a single m2.
  // Bumped for the bill clean-up and ask-the-bill prompts (billCleanupService,
  // billAskService). New features, so nothing cached is invalidated in anger —
  // the bump keeps audit rows honest about which prompt produced a verdict.
  promptVersion: "2026-07-28.5",
